...
//				/*put_px(x, y, *color_p)*/
//				ILI9341_DrawDot(x,y,color_p->full);
//	//            	LCD_DrawDot(x,y,p->full);
//				color_p++;
//			}
//		}


    	//attempt at optimization 1
...
////		        *(uint16_t*)((uint32_t)0x60020000) = color_p->full; //DataAccess
//		    	  *(uint16_t*)((uint32_t)0x60020000) = *(uint16_t*)color_p;
//		        color_p++;
//
//		      }
//		}
		...
		// start dma transfer, parameters: pointer to dma channel, data, destination buffer address, size of data, send to 0x60020000 (FSMC ILI9341 data address)
